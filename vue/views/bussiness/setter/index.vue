  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['bussiness:setter:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="setterList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="类型" align="center" prop="homeType" />
      <el-table-column label="功能" align="center" prop="modelType" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="语言" prop="languageName">
          <el-input v-model="form.languageName" placeholder="请输入语言" />
        </el-form-item>
        <el-form-item label="点赞数" prop="likesNum">
...
<script>
import { listSetter, getSetter, delSetter, addSetter, updateSetter } from "@/api/bussiness/setter";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除规则说明编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('bussiness/setter/export', {
        ...this.queryParams
