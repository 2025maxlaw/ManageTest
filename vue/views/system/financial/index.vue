<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否热销1是0否" prop="isHot">
        <el-input
          v-model="queryParams.isHot"
          placeholder="请输入是否热销1是0否"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="日平均利率" prop="avgRate">
        <el-input
          v-model="queryParams.avgRate"
          placeholder="请输入日平均利率"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="平台基础投资金额" prop="basicInvestAmount">
        <el-input
          v-model="queryParams.basicInvestAmount"
          placeholder="请输入平台基础投资金额"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="平台总投资额" prop="totalInvestAmount">
        <el-input
          v-model="queryParams.totalInvestAmount"
          placeholder="请输入平台总投资额"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="易购金额" prop="purchasedAmount">
        <el-input
          v-model="queryParams.purchasedAmount"
          placeholder="请输入易购金额"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="financialList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否热销1是0否" align="center" prop="isHot" />
      <el-table-column label="排序" align="center" prop="sort" />
      <el-table-column label=" 购买次数" align="center" prop="buyPurchase" />
      <el-table-column label="日平均利率" align="center" prop="avgRate" />
      <el-table-column label="币种 " align="center" prop="coin" />
      <el-table-column label="分类" align="center" prop="classify" />
      <el-table-column label="平台基础投资金额" align="center" prop="basicInvestAmount" />
      <el-table-column label="平台总投资额" align="center" prop="totalInvestAmount" />
      <el-table-column label="VIP等级 " align="center" prop="level" />
      <el-table-column label="项目进度" align="center" prop="process" />
      <el-table-column label="剩余金额" align="center" prop="remainAmount" />
      <el-table-column label="标签" align="center" prop="remark" />
      <el-table-column label="易购金额" align="center" prop="purchasedAmount" />
      <el-table-column label="常见问题" align="center" prop="problem" />
      <el-table-column label="产品介绍" align="center" prop="prodectIntroduction" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否热销1是0否" prop="isHot">
          <el-input v-model="form.isHot" placeholder="请输入是否热销1是0否" />
        </el-form-item>
        <el-form-item label="排序" prop="sort">
        ...
        <el-form-item label="日平均利率" prop="avgRate">
          <el-input v-model="form.avgRate" placeholder="请输入日平均利率" />
        </el-form-item>
        <el-form-item label="币种 " prop="coin">
        ...
        <el-form-item label="平台基础投资金额" prop="basicInvestAmount">
          <el-input v-model="form.basicInvestAmount" placeholder="请输入平台基础投资金额" />
        </el-form-item>
        <el-form-item label="平台总投资额" prop="totalInvestAmount">
          <el-input v-model="form.totalInvestAmount" placeholder="请输入平台总投资额" />
        </el-form-item>
        <el-form-item label="VIP等级 " prop="level">
          <el-input v-model="form.level" placeholder="请输入VIP等级 " />
        </el-form-item>
        <el-form-item label="项目进度" prop="process">
          <el-input v-model="form.process" placeholder="请输入项目进度" />
        </el-form-item>
        <el-form-item label="剩余金额" prop="remainAmount">
          <el-input v-model="form.remainAmount" placeholder="请输入剩余金额" />
        </el-form-item>
        <el-form-item label="标签" prop="remark">
          <el-input v-model="form.remark" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="易购金额" prop="purchasedAmount">
          <el-input v-model="form.purchasedAmount" placeholder="请输入易购金额" />
        </el-form-item>
        ...
        <el-form-item label="产品介绍" prop="prodectIntroduction">
          <el-input v-model="form.prodectIntroduction" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
