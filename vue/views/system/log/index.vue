<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="访问位置" prop="loginLocation">
        <el-input
      ...
      <el-form-item label="系统OS" prop="os">
        <el-input
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="访问IP" prop="ipaddr">
          <el-input v-model="form.ipaddr" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="访问位置" prop="loginLocation">
          <el-input v-model="form.loginLocation" placeholder="请输入访问位置" />
        </el-form-item>
        <el-form-item label="浏览器" prop="browser">
          <el-input v-model="form.browser" placeholder="请输入浏览器" />
        </el-form-item>
        <el-form-item label="系统OS" prop="os">
          <el-input v-model="form.os" placeholder="请输入系统OS" />
        </el-form-item>
        <el-form-item label="" prop="msg">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除系统访问记录编号为"' + ids + '"的数据项？').then(function() {
        return delLog(ids);
      }).then(() => {
        this.getList();
