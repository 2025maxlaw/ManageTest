 ...
 */
@RestController
@RequestMapping("/bussiness/currency")
public class TCurrencySymbolController extends BaseController
{
     ...
     * 查询币币交易币种配置列表
     */
    @PreAuthorize("@ss.hasPermi('bussiness:currency:list')")
    @GetMapping("/list")
     ...
     * 导出币币交易币种配置列表
     */
    @PreAuthorize("@ss.hasPermi('bussiness:currency:export')")
     ...
     * 获取币币交易币种配置详细信息
     */
    @PreAuthorize("@ss.hasPermi('bussiness:currency:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增币币交易币种配置
     */
    @PreAuthorize("@ss.hasPermi('bussiness:currency:add')")
     ...
     * 修改币币交易币种配置
     */
    @PreAuthorize("@ss.hasPermi('bussiness:currency:edit')")
     ...
     * 删除币币交易币种配置
     */
    @PreAuthorize("@ss.hasPermi('bussiness:currency:remove')")
